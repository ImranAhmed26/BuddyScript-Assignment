      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="_feed_inner_text_area_bottom">
          <div className="_feed_inner_text_area_item">
            ...
            <div className="_feed_inner_text_area_bottom_video _feed_common" title="Video posts are coming soon">
            ...
            <div className="_feed_inner_text_area_bottom_event _feed_common" title="Events are coming soon">
              <span className="_feed_inner_text_area_bottom_photo_link" style={{ opacity: 0.5, cursor: 'default' }}>
                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
            ...
            <div className="_feed_inner_text_area_bottom_article _feed_common" title="Articles are coming soon">
              <span className="_feed_inner_text_area_bottom_photo_link" style={{ opacity: 0.5, cursor: 'default' }}>
                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
