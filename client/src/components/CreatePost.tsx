...
function PhotoButton({ onClick, label = 'Photo' }: { onClick: () => void; label?: string }) {
  return (
    <div className="_feed_inner_text_area_bottom_photo _feed_common">
      <button type="button" className="_feed_inner_text_area_bottom_photo_link bs-clickable" onClick={onClick}>
...
// Video/Event/Article: static mockup-parity buttons, not implemented.
function StaticComposerAction({
  className,
  title,
  path,
  label,
  ...
  return (
    <div className={`${className} _feed_common`} title={title}>
      <span className="_feed_inner_text_area_bottom_photo_link" style={{ opacity: 0.5, cursor: 'default' }}>
        <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
...
function PostButton({ pending }: { pending: boolean }) {
  return (
    <div className="_feed_inner_text_area_btn">
      <button type="submit" className="_feed_inner_text_area_btn_link" disabled={pending}>
...
export function CreatePost() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      await createPost.mutateAsync({ content: content.trim(), visibility: 'PUBLIC', image });
      reset();
    } catch (err) {
    ...
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <form onSubmit={onSubmit}>
        ...
        <div className="_feed_inner_text_area_bottom">
          ...
          <div className="_feed_inner_text_area_item" style={{ gap: 12 }}>
            <PostButton pending={createPost.isPending} />
          </div>
        </div>
        ...
        <div className="_feed_inner_text_area_bottom_mobile">
          <div className="_feed_inner_text_mobile">
            <div className="_feed_inner_text_area_item">
              <PhotoButton onClick={openFilePicker} label="" />
              <StaticComposerAction
                className="_feed_inner_text_area_bottom_video"
                title="Video posts are coming soon"
                label=""
